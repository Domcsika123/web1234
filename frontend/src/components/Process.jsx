        ...
        <div className="max-w-6xl mx-auto">
            ...
            {process.map((step, index) => {
              ...
              return (
                <div key={step.id} className="relative flex flex-col">
                  {/* Number badge and Icon - Side by side on mobile, stacked on desktop */}
                  <div className="flex md:flex-col items-center justify-center md:justify-start gap-4 md:gap-0 mb-4 md:mb-6">
                    <span className="text-2xl font-black text-brand-primary md:mb-4">{step.step}</span>
          ...
          <div className="mt-10 md:mt-16 text-center">
            <div className="inline-flex flex-col sm:flex-row items-center gap-4 sm:gap-6 md:gap-8 px-6 md:px-12 py-4 rounded-full bg-transparent border border-brand-primary">
              <span className="caption text-brand-primary text-sm font-bold">1–4 HÉT</span>
